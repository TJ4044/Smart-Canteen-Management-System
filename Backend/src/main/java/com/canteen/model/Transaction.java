...
public class Transaction {
    ...
    public static class Builder {
        ...
        public Builder type(TransactionType t){this.type=t;return this;} public Builder amount(Double a){this.amount=a;return this;}
        public Builder description(String d){this.description=d;return this;} public Builder createdAt(LocalDateTime c){this.createdAt=c;return this;}
        public Transaction build(){Transaction t=new Transaction();t.id=id;t.user=user;t.type=type;t.amount=amount;t.description=description;t.createdAt=createdAt;return t;}
    }
}
