...
public class OrderItem {
    ...
    public static class Builder {
        ...
        public Builder foodItem(FoodItem f){this.foodItem=f;return this;}
        public Builder quantity(Integer q){this.quantity=q;return this;}
        public Builder unitPrice(Double u){this.unitPrice=u;return this;}
        public Builder subtotal(Double s){this.subtotal=s;return this;}
        public OrderItem build(){OrderItem oi=new OrderItem();oi.id=id;oi.order=order;
            oi.foodItem=foodItem;oi.quantity=quantity;oi.unitPrice=unitPrice;oi.subtotal=subtotal;return oi;}
    }
}
