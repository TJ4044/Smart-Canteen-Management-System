...
public class User {
    ...
    public static class Builder {
        private Long id; private String name, email, password, phone; private Role role;
        private Double walletBalance = 0.0; private Boolean active = true;
        ...
        public User build() { User u = new User(); u.id=id; u.name=name; u.email=email; u.password=password; u.phone=phone; u.role=role; u.walletBalance=walletBalance; u.active=active; return u; }
    }
}
