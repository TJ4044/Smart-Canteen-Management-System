...
public class FoodItem {
    ...
    public static class Builder {
        private Long id; private String name, description, imageUrl; private Double price;
        private Category category; private Boolean available = true; private Integer stockQuantity = 0;
        ...
        public FoodItem build() { FoodItem f=new FoodItem(); f.id=id; f.name=name; f.description=description; f.price=price; f.category=category; f.imageUrl=imageUrl; f.available=available; f.stockQuantity=stockQuantity; return f; }
    }
}
